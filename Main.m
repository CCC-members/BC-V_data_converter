...
if(isfile(fullfile("dataset_properties",app_properties.selected_data_set.file_name)))
    try
        selected_data_set = jsondecode(fileread(fullfile('dataset_properties',app_properties.selected_data_set.file_name)));
        app_properties.selected_data_set = selected_data_set;
    catch
